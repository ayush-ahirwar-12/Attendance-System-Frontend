...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-[rgba(182,160,255,0.2)] rounded-2xl bg-[#12121e]">
      ...
      <h2 className="text-xl font-bold text-[#e9e6f7] mb-2">My Classes</h2>
      <p className="text-[#aba9b9] text-sm max-w-md text-center">
        This section is currently under development. Here you will be able to manage your assigned classes and see their details.
      </p>
    </div>
  );
}
